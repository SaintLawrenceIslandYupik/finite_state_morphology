...
test-ch3: ess.pairs.gold/Ch3.N_ABS.tsv ess.pairs.gold/Ch3.N_AblMod.tsv ess.fomabin
	@cut -f 1 ess.pairs.gold/Ch3.N_ABS.tsv     | sort -d -f | uniq | flookup -i -w "" ess.fomabin | sort -d -f | diff - ess.pairs.gold/Ch3.N_ABS.tsv     && echo "Jacobson (2001) Chapter 3 Noun Vocabulary - Absolutive Unpossessed                - PASS" || echo "Jacobson (2001) Chapter 3 Noun Vocabulary - Absolutive Unpossessed                - FAIL"
...
test-ch8: ess.pairs.gold/Ch8.V_Intrg.1-2Intr.tsv ess.pairs.gold/Ch8.V_Intrg.2SgTrns.tsv ess.pairs.gold/Ch8.N_ABS.4PossPosd.tsv ess.fomabin
